					...
					<div className='custom-scrollbar p-[32px] overflow-y-auto text-left'>
						...
						<div className='space-y-6'>
							...
							<div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3'>
								...
								<button onClick={() => setTipoAvaliacao("Técnico de Enfermagem")} className='text-left p-4 rounded-xl border-2 transition-all border-[#cd0048] bg-[#cd0048]/5'>
									<p className='font-semibold text-sm text-foreground'>Autoavaliação: Técnico de Enfermagem</p>
									<p className='text-xs [text-#555f69] mt-1'>O técnico de enfermagem avalia sua própria performance técnica e comportamental</p>
								</button>
							</div>
