					...
					<div className='custom-scrollbar p-[32px] overflow-y-auto text-left'>
						...
						<div className='space-y-6'>
							...
							<div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3'>
								...
								<button onClick={() => setTipoAvaliacao("Liderança / Coordenação")} className='text-left p-4 rounded-xl border-2 transition-all border-[#d2d8de] bg-[#f6f6f6] hover:border-[#cd0048]/40'>
									<p className='font-semibold text-sm text-foreground'>Simulação Liderança / Coordenação</p>
									<p className='text-xs [text-#555f69] mt-1'>Avaliação em cenário simulado — Liderança, Trabalho em Equipe, Gerenciamento de Tarefas e NTS</p>
								</button>
							</div>
