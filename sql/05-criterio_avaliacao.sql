...
INSERT INTO criterios_avaliacao (tipo, categoria, codigo, criterio, indicador, peso) VALUES
(
    'BP-TEAM',
    'Liderança',
    'BT-L1',
...
(
    ...
    'Comportamental', 
    'C-B1',
    'Comunica-se com a equipe, antecipando necessidades, cooperando na cena e comunicando informações relevantes',
    'Trabalho em equipe',
    3
),
...
(
    ...
    'Liderança',
    'MD-L5',
    'Promove o trabalho em equipe, a comunicação efetiva e o ambiente de segurança psicológica para toda a equipe',
    'Clima de equipe / segurança psicológica',
    2   
),
